...
This file contains all credit approvals from your past loan applicants the bank has ever completed.
- customers-to-score.xlsx 
This is the new set of customers that you need to score on the classification model you will create
